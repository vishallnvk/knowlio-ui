 ...
 * Handles user login, registration, and social authentication
 */
function Login() {
  const navigate = useNavigate();
  // Authentication mode: 'signin', 'signup', or 'confirm'
  ...
  /**
   * Get the appropriate subtitle for the current mode
   */
  const getSubtitle = () => {
    switch (mode) {
      case 'signin':
      ...
      case 'signup':
        return 'Sign up to get started with Knowlio';
      case 'confirm':
