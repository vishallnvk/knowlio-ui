...
import { useUserAgreementAttributes, saveUserAgreementAttributes, UserAgreementConsent } from '@/lib/api/license';
...
export default function UserAgreementPage() {
  ...
  const { data: userAgreementResponse, isLoading: isStatusLoading, error: statusError } = useUserAgreementAttributes();
  ...
  const isAgreementSigned = userAgreementResponse?.success && userAgreementResponse.data?.ai_user_agreement_consent;
    ...
    return (
      <Box sx={{ p: 3 }}>
        <Alert severity="error">
          <Typography variant="h6">Error Loading User Agreement Information</Typography>
          <Typography variant="body2">
            {statusError && typeof statusError === 'object' && 'message' in statusError 
          ...
          {isAgreementSigned ? (
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                      <Box>
                        ...
                        <Typography variant="body2" color="text.secondary" gutterBottom>
                          Version: {userAgreementResponse?.data?.ai_user_agreement_version || 'v2.1'}
                        </Typography>
                      </Box>
                      <Chip 
                        icon={<VerifiedIcon />} 
                    ...
                    <Stack spacing={2}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                        <Typography variant="body2" color="text.secondary">Agreement Type</Typography>
                        <Typography variant="body2" fontWeight="medium">User Agreement</Typography>
                      </Box>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <Typography variant="body2">{userAgreementResponse?.data?.ai_user_agreement_version || 'v2.1'}</Typography>
                      </Box>
                    </Stack>
                  </CardContent>
                </Card>
            ...
            <Box>
              <Box sx={{ p: 3, backgroundColor: '#fff7ed', borderBottom: 1, borderColor: 'divider' }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Please review and accept the user agreement to continue using all features.
                </Typography>
              </Box>
              ...
              <Box sx={{ p: 3 }}>
                ...
                <Typography variant="body2" paragraph>
                  Before using our platform, please review the key terms of our user agreement:
                </Typography>
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  {!hasViewedFullAgreement && (
                    <Typography variant="body2" color="text.secondary" sx={{ mt: 1, ml: 4 }}>
                      Please view the full agreement first to enable this option.
                    </Typography>
                  )}
                </Box>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Button
                    variant="contained"
                    color="primary"
                    disabled={!agreedToTerms || !hasViewedFullAgreement || isSubmitting}
